...
public class CT010 {
	...
	public void tearDown() throws Exception {
		...
		try {
			...
			ImageIO.write(bi, "jpg",
					new File("C:\\Users\\Public\\Projetos\\JoaoSegundaFase\\segundaFase\\screen\\CT0010,jpg"));
	...
	public void test() throws Exception {
		...
		System.out.println("Adiconar um novo endereço");
		endereco.adicionarNovoEndereco();
